...
public class Teacher extends Employee {
    ...
    public Teacher(String userId, String login, String password, String firstName, String lastName, double salary, LocalDate hireDate, Vector<Courses> courses, TeacherDegree degree) {
