...
public class Researcher extends Employee{
    ...
    public Researcher(String userId, String login, String password, String firstName, String lastName, double salary, LocalDate hireDate, Vector<ResearchPaper> projects) {
