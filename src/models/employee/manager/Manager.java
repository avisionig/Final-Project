...
public class Manager extends Employee {
    ...
    public Manager(String userId, String login, String password, String firstName, String lastName, double salary, Date hireDate, ManagerType type, List<News> listNews) {
